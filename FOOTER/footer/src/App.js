...
const App = () => {
  ...
  <div className="footer-container" style={{ backgroundColor: '#32012F' }}>
			...
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="flex-shrink-0 w-5 h-5 rounded-full dark:text-gray-50">
						<image href="AI-LOGO.png" width="32" height="32" />
					</svg>
				</div>
				<span className="self-center text-2xl font-semibold">MENTOR AI.</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<a rel="noopener noreferrer" href="#">JOIN US</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">F.A.Q</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">SITEMAP</a>
					</li>
          <li>
						<a rel="noopener noreferrer" href="#">CONDITIONS</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">LICENSE</a>
					</li>
				</ul>
			</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-600">© 2024 MENTOR AI . All rights reserved.</div>
   </div>
</footer>
  );
}
